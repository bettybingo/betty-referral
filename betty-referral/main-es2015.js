...
let UserReferralComponent = class UserReferralComponent {
    constructor(fb, router, clickToChat) {
        this.fb = fb;
        this.router = router;
    ...
    submitPromoCode() {
        ...
        const urlText = 'signup on bettybingo at http://bettybingo.co.zm/registration-page/' + promocode + ' for amazing gaming experience';
        ...
        const finalUrl = `https://wa.me/?text=${encodedUrlText}`;
...
let NotFound404ComponentComponent = class NotFound404ComponentComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PromoCodeResolver = class PromoCodeResolver {
    ...
    resolve(route) {
        const promoCode = route.paramMap.get('promo-code');
...
let ClickToChatService = class ClickToChatService {
    constructor(http) {
        this.http = http;
    }
};
